<template>
   ...
   <section class="shortcut">
    <div class="w">
      ...
      <div class="fr">
        <ul>
          <li><a  class="style_red" @click="resellerIndex">首页</a></li>
          <li></li>
          <li>
...
const addProduct = () => {
  axios
    .post("/api/store/addProduct", addForm.value, {
      headers: {
        Authorization: data,
...
const updateProduct = () => {
  axios
    .put(`/api/store/updateProduct`, editForm.value, {
      headers: {
        Authorization: data,
        "Content-Type": "application/json",
      },
...
const deleteProduct = (product) => {
  axios
    .delete("/api/store/deleteProduct", {
      data: product,
      headers: {
        Authorization: data,
        "Content-Type": "application/json",
