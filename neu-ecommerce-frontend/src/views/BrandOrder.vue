<template>
    ...
    <div class="w">
      ...
      <div class="fr">
        <ul>
          ...
          <li></li>
          <li><a class="style_red" @click="brandOrder">我的订单</a></li>
          <li></li>
          <li>
            <a>电子钱包</a>
            <div class="dropdown">
  ...
  <div class="w">
        ...
        <table class="layui-table">
          ...
          <tbody id="order-table-body">
            <template v-for="order in orders" :key="order.id">
              <tr v-if="order.status == '待发货' || order.status == '已发货' || order.status == '已送达'">
              <td>{{ order.id }}</td>
              <td>{{ order.storeId }}</td>
              ...
              <td>
                ...
                <button
                  ...
                  v-if="!order.logisticsNumber && order.status == '已发货'"
                >
                  上传物流单号
                </button>
              </td>
    ...
    <div class="overlay" v-if="dialogVisible">
      <div class="dialog">
        <form @submit.prevent="postLogisticsNumber">
              ...
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    class="inp"
                    v-model="editForm.logisticsNumber"
                  />
                </td>
              </tr>
              <!-- <tr>
                  ...
                  <td>
                    <input type="text" class="inp" v-model="editForm.logisticsType" />
                  </td>
                </tr> -->
            </tbody>
          </table>
...
const postLogisticsNumber = (order) => {
  axios
    .put(`/api/brand/updateOrder`, editForm.value, {
      headers: {
        Authorization: data,
        "Content-Type": "application/json",
      },
