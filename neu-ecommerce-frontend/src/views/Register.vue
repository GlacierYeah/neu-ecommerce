<template>
  <div class="w">
    ...
    <div class="registerarea">
      <h3>
        注册新用户
        <div class="login">我有账号，去<a @click="login">登录</a></div>
      </h3>
      <div class="reg_form">
        <form @submit.prevent="register">
          <ul>
            <li>
              ...
              <select id="identity" class="inp" v-model="userRegisterForm.role">
...
const userNameError = () => !userRegisterForm.value.userName;
const userPasswordError = () => !userRegisterForm.value.password;
const userCaptchaError = () => !userRegisterForm.value.captcha;
...
const register = async () => {
  ...
  const requestData = {
    ...
    verificationCode: userRegisterForm.value.captcha,
  ...
  axios
    .post("/api/user/register", qs.stringify(requestData), {
      headers: {
