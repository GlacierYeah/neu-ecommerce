        ...
        <ul>
          ...
          <li>
            ...
            <div class="dropdown">
              ...
              <a class="style_red" @click="resellerStoreInfo">信息管理</a>
            </div>
          </li>
          <li></li>
      ...
      <div class="store_form">
        <form action="" style="font-size: 15px">
          <table class="layui-table table-center" style="margin-top: -35px">
            ...
            <tbody v-if="store">
              <tr>
                <td><label for="">网店名称：</label></td>
                <td>
                  <span>{{ store.name }}</span>
                </td>
              </tr>
              <tr>
                <td><label for="">网店logo：</label></td>
                <td>
                  <img
                    v-if="store.logo"
                    :src="store.logo"
              ...
              <tr>
                <td><label for="">网店邮箱：</label></td>
                <td>
                  <span>{{ store.contactEmail }}</span>
                </td>
              </tr>
              <tr>
                <td><label for="">网店地址：</label></td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span>{{ store.registrationDatetime }}</span>
                </td>
              </tr>
...
axios
  ...
  .then((response) => {
    ...
    editForm.value = {
      ...
      contactName: store.value.contactName,
      contactPhone: store.value.contactPhone,
      contactEmail: store.value.contactEmail,
      address: store.value.address,
      brandsId: store.value.brandsId,
    };
...
const addStore = () => {
  ...
  axios
    .post("/api/store/register", addForm.value, {
      headers: {
        Authorization: data,
...
const update = () => {
  axios
    .put("/api/store/update", editForm.value, {
      headers: {
        Authorization: data,
      },
    })
    .then((response) => {
      ...
      store.value = { ...editForm.value }; // 更新原始数据
      dialogVisible.value = false;
      console.log(store.value.logo);
    })
    .catch((error) => {
      console.error(error);
      alert("更新失败");
